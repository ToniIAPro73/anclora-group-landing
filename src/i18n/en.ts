...
const en: Dictionary = {
  ...
  products: {
    ...
    items: {
      ...
      'anclora-guesthub': { description: 'Guest management, check-in and vacation rental operations.', status: 'internal ecosystem' },
      ...
      'anclora-insights': { description: 'Anclora Group editorial imprint dedicated to research, analysis and applied knowledge creation.', status: 'internal ecosystem' },
      'anclora-content-generator-ai': { description: 'Tool for creating, transforming and adapting content with artificial intelligence.', status: 'internal ecosystem' },
      'anclora-talent': { description: 'Editorial platform to create, edit, layout and publish digital projects.', status: 'paused' },
