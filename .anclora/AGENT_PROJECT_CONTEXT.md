# Anclora Group Landing — Agent Project Context
...
- **PRODUCTION_RUNTIME**: [`.anclora/PRODUCTION_RUNTIME.md`](PRODUCTION_RUNTIME.md)
  - Confirms status `STATIC_PRODUCTION_RUNTIME`, deployed on Vercel (`https://anclora-group-landing-cqqcgzamg-pmi140979-6354s-projects.vercel.app`), with FULL_PROMOTION Git workflow model.
