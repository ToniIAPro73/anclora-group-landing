...
const es: Dictionary = {
  ...
  products: {
    ...
    items: {
      ...
      'anclora-insights': { description: 'Sello editorial de Anclora Group dedicado a la investigación, el análisis y la creación de conocimiento aplicado.', status: 'ecosistema interno' },
      'anclora-content-generator-ai': { description: 'Herramienta para crear, transformar y adaptar contenidos mediante inteligencia artificial.', status: 'ecosistema interno' },
      'anclora-talent': { description: 'Plataforma editorial para crear, editar, maquetar y publicar proyectos digitales.', status: 'en pausa' },
